...
DEFINE FILENAME = &PATH/komplexitaet_fbs_alle.htm

SET TERMOUT ON
PROMPT Erstelle komplexitaet_fbs_alle.htm ...
PROMPT
SET TERMOUT OFF
SPOOL &FILENAME
DECLARE
...
db_report_output.subtitle ('anzahl', 'Applikations Komplexität FBS Übersicht');
